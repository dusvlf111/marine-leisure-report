...
- [ ] 1.0 프로젝트 초기 설정 및 환경 구축
    - [ ] 1.1 Next.js 프로젝트 생성 및 기본 설정
    - [ ] 1.2 필수 패키지 설치 (Animate.css, React Hook Form, Zod 등)
    - [ ] 1.3 TypeScript 설정 및 경로 별칭 구성
    - [ ] 1.4 환경 변수 설정 (.env.local)
    - [ ] 1.5 Animate.css 글로벌 설정 및 커스텀 클래스 정의
    - [ ] 1.6 폴더 구조 생성 및 기본 파일 템플릿 작성
